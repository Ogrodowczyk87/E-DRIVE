...
export const useGoogleAuth = () => {
    ...
    // Zwracamy funkcje i stan do użycia w komponentach
    return { 
        user,      // Dane użytkownika (null jeśli nie zalogowany)
        login,     // Funkcja logowania
        logout,    // Funkcja wylogowania
        loading,   // Stan ładowania (boolean)
        token      // Token dostępu (string | null)
    };
}
